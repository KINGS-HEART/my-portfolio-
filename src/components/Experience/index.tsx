...
const certifications = [
  ...
  {
    title: 'ALT SCHOOL CERTIFICATE',
    issuer: 'BY ALT SCHOOL',
    date: 'MARCH 2026',
    description: 'FRONTEND ENGINEERING',
    image: '/images/certifications/ALT school CERT.jpeg',
  },
  {
...

  {
    ...
    image: '/images/certifications/sololearn-html.jpeg',
  },
];
...
export default function Experience() {
  ...
  {selectedImage && (
    <motion.div
      className="fixed inset-0 z-[9999] bg-black/90 flex flex-col items-center justify-center gap-4"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
