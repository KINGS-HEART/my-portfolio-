  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container-max px-4 sm:px-6 lg:px-8 text-center pt-20">
        ...
        >
          <TextScramble
            texts={['Frontend Developer', 'Engineering Lover', 'Open Source Contributor', 'UI/UX Designer']}
        ...
        >
          I develop responsive and user-friendly web interfaces using HTML, CSS, JavaScript, and modern tools like React and Bootstrap. Passionate about turning complex ideas into clean, interactive, and visually engaging user experiences.
        </motion.p>
        ...
        >
          <MagneticButton strength={0.4}>
            <motion.a
              href="https://github.com/KINGS-HEART/KINGS-HEART"
              target="_blank"
          ...
          <MagneticButton strength={0.4}>
            <motion.a
              href="https://www.linkedin.com/in/kingsley-ebuka-dunu-a67102230/recent-activity/all/"
              target="_blank"
              rel="noopener noreferrer"
              whileHover={{ scale: 1.15, y: -3 }}
              className="w-12 h-12 glass rounded-xl flex items-center justify-center text-foreground-muted
