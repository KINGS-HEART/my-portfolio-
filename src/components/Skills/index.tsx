...
const categoryLabels: Record<string, { label: string; color: string }> = {
  ...
  backend: { label: 'Frameworks', color: 'from-accent-500 to-accent-700' },
  databases: { label: 'Tools', color: 'from-highlight-500 to-highlight-700' },
  tools: { label: 'Concepts', color: 'from-green-500 to-green-700' },
};
...
export default function Skills() {
  ...
  const [activeCategory, setActiveCategory] = useState<keyof SkillsData>('languages');

  const categories = Object.keys(categoryLabels) as (keyof SkillsData)[];
