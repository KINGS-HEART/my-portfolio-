...
const cardVariants: Variants = {
  ...
  visible: (i: number) => ({
    ...
    transition: {
      duration: 0.6,
      delay: i * 0.12,
      ease: [0.25, 0.46, 0.45, 0.94] as const, // ✅ FIX
    },
  }),
...
export default function Projects() {
  ...
  description: "A real-time Markdown editor built with Vue, JavaScript, and TypeScript, allowing users to write and preview formatted content instantly.",
  image: "/images/projects/project1.png",
  technologies: ["Vue", "JavaScript", "TypeScript"],
  githubUrl: "https://github.com/KINGS-HEART",
  ...
  description: "A modern blog platform with structured content layout, responsive design, and clean user interface for reading and navigating articles.",
