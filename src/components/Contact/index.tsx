...
const contactInfo = [
  { icon: <HiMail size={22} />, label: 'Email', value: 'kingsleydunu@gmail.com', href: 'mailto:kingsleydunu@gmail.com' },
  { icon: <HiLocationMarker size={22} />, label: 'Location', value: 'Lagos, Nigeria' },
  { icon: <HiPhone size={22} />, label: 'Phone', value: '08135144051', href: 'tel:08135144051' },
];

const socials = [
  { icon: <FaGithub size={20} />, href: 'https://github.com/KINGS-HEART', label: 'GitHub' },
  { icon: <FaLinkedinIn size={20} />, href: 'https://linkedin.com/in/kingsley-ebuka-dunu-a67102230', label: 'LinkedIn' },
  { icon: <FaTwitter size={20} />, href: 'https://x.com/kingsley_d86119?t=IQvosDdc8_qcEy5-JI4nUg&s=08', label: 'Twitter' },
];
